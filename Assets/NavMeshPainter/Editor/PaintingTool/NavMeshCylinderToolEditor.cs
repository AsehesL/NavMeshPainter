...
{
    [CustomNavMeshToolEditor(typeof (NavMeshCylinderTool))]
    public class NavMeshCylinderToolEditor : NavMeshToolEditor
    {
        private bool m_IsDragging;

        public override void DrawGUI()
        {
            var t = target as NavMeshCylinderTool;
            if (t == null)
                return;
        ...
        protected override void OnSceneGUI(NavMeshPainter targetPainter)
        {
            ...
            if (m_IsDragging)
            {
                NavMeshEditorUtils.DrawWireCylinder(t.bounds, Color.blue);
            }
            else
            {
                NavMeshEditorUtils.DrawWireCylinder(t.beginPos, new Vector3(1, t.bottomHeight + t.topHeight, 1), Color.blue);
            }
